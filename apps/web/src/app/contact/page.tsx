...
export default function ContactPage(): JSX.Element {
  return (
    <div className="container py-16 md:py-24">
      <div className="grid gap-12 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground">
            For product inquiries, partnerships, exports, and general support, email or call our
            team directly.
          </p>
      ...
      <div className="mt-12">
        <ProductCta
          eyebrow="Need a product conversation?"
          title="Start with the range, then talk to our team."
          description="Tell us what your market needs and we will help you navigate the Parshlo portfolio."
        />
      </div>
    </div>
  );
